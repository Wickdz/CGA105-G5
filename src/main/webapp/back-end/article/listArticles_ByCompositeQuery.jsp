...
<jsp:useBean id="listArticles_ByCompositeQuery" scope="request"
             type="java.util.List<com.musclebeach.article.model.ArticleVO>"/>
...
<table id="table-1">
    <tr>
        <td>
            ...
            <h4><a href="<%=request.getContextPath()%>/back-end/article/select_page.jsp"><img src="images/back1.gif"
                                                                                              width="100" height="32"
                                                                                              border="0">回首頁</a></h4>
        </td>
    </tr>
...
<table>
    ...
    <c:forEach var="articleVO" items="${listArticles_ByCompositeQuery}" begin="<%=pageIndex%>"
        ...
        <tr align='center' valign='middle'>
            ...
            <!-- 			</td> -->
            <td>
                <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/back-end/article/article.do"
