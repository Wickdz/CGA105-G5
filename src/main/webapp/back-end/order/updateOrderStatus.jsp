                            ...
                            <div class="mb-3 mb-xl-0 pr-1">
                                <div class="dropdown">
                                    <button style="margin-right:10px;">
                                        <a href="listAllOrder.jsp"><img src="./images/home.png" title="返回所有訂單"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <FORM METHOD="post" ACTION="<%=request.getContextPath() %>/back-end/order/"
                                          name="form1">
                                        <table>
                                            <tr>
                                                <td>編號:<font color=red><b>*</b></font></td>
                                                <td><%=orderVO.getOrderID()%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>名稱:</td>
                                                <td><%=orderVO.getOrderRecName()%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>電話:</td>
                                                <td><%=orderVO.getOrderRecPhone()%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>地址:</td>
                                                <td><%=orderVO.getOrderAddress()%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>金額:</td>
                                                <td><%=orderVO.getTotalPrice()%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>狀態:</td>
