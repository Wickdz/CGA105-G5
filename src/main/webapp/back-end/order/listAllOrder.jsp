...
<%
MasterService prodSvc = new MasterService();
List<OrderMaster> list = prodSvc.getAll();
					...
					<div class="row">
						<div class="col-sm-6">
							<ul class="nav nav-treeview">
					            <li class="nav-item">
					              <a href="<%=request.getContextPath() %>/back-end/product/listAllProd.jsp" class="nav-link">
