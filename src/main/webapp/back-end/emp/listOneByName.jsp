...
<%
List<EmpVO> list = (List<EmpVO>) request.getAttribute("list"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<tbody>
					<c:forEach var="empVO" items="${list}">
						<tr>
							...
							<td><img
								src="${pageContext.request.contextPath }/back-end/emp/emp.do?action=getImg&empID=${empVO.empID}"></td>
							<td>
