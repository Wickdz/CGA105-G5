...
<body>
	...
	<div class="tab-content" id="v-pills-tabContent"
		...
		<div class="tab-pane fade show active" id="v-pills-service"
			...
			style="width:100%">
			<jsp:useBean id="listQuestionByQuestionTitleB" scope="request"
				type="java.util.Set<QuestionVO>" />

			<jsp:useBean id="questionSvc" scope="page"
				class="com.question.model.QuestionService" />
			<table id="table-1">
				<tr>
					<td>
						<h3>常見問題</h3>
			...
			<table>
				...
				<c:forEach var="questionVO" items="${listQuestionByQuestionTitleB}">
						...
						<td>
							<FORM METHOD="post"
								...
								<input type="submit" value="修改"> <input type="hidden"
									name="questionID" value="${questionVO.questionID}"> <input
