...
<div class="tab-content" id="v-pills-tabContent"
    ...
    <div class="tab-pane fade show active" id="v-pills-service"
        ...
        <table id="table-1">
            <%
                QuestionVO newsVO = (QuestionVO) request.getAttribute("questionVO");
            %>
        ...
        <FORM METHOD="post" ACTION="question.do" name="form1"
            ...
            <table>
                ...
                <tr>
                    <td>常見問題內容:</td>
                    <td><textarea name="questionContent" rows="10" cols="45"
                                  placeholder="xxx"/></textarea></td>
                </tr>
            </table>
            <br> <input type="hidden" name="action" value="insert">
            <input style="margin-left: 150px;" type="submit" value="送出新增">
