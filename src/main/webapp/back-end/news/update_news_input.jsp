		...
		<div class="tab-pane fade show active" id="v-pills-service"
			...
			<FORM METHOD="post" ACTION="news.do" name="form1"
				...
				<table>
					...
					<tr>
						<td>標題內容:</td>
						<td><textarea name="newsContent" rows="10" cols="45" /><%=newsVO.getNewsContent()%></textarea>
						</td>
					</tr>

				</table>
				<br> <input type="hidden" name="action" value="update">
				<input type="hidden" name="news" value="<%=newsVO.getNewsID()%>">
				<input type="hidden" name="newsTime"
					value="<%=newsVO.getNewsTime()%>"> <input type="submit"
					style="margin-left: 180px;" value="送出修改"> <input
					type="button"
