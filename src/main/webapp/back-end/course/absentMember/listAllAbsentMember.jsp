...
<%
    ...
    assert ctx != null;
    AbsentMemberService absentMemberService = ctx.getBean(AbsentMemberService.class);
    List<AbsentMemberVO> list = absentMemberService.getAll();
...
<head>
    ...
    <title>所有課程時間表 - listAllClassSchedule.jsp</title>
...
<div class="tab-content" id="v-pills-tabContent"
    ...
    >
        ...
        <table id="table-2">
            ...
            <tbody>
            <c:forEach var="absentMemberVO" items="${list}">

            <tr>
                <td>${absentMemberVO.timeID}</td>
                <td>${absentMemberVO.memID}</td>
