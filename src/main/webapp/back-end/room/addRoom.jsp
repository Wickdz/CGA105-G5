...
<div class="tab-content" id="v-pills-tabContent" style="width: 100%; height: calc(100vh - 70px);">
    ...
    <!-- ========================================= 員工管理 ========================================= -->
    <div class="tab-pane fade p-3 container" id="v-pills-employee" role="tabpanel"
    ...
    <div class="tab-pane fade" id="v-pills-shop" role="tabpanel"
         ...
         style="border: 2px solid brown"></div>
    <!-- ========================================= 教練管理 ========================================= -->
    ...
    <div class="tab-pane fade show active p-3 container" id="v-pills-room"
        ...
        <div>
            <div class="d-inline display-6" style="margin-right: 644px;">新增場地資料</div>
            <div class="d-inline">
                ...
                <div class="row">
                    <div class="col-12 col-md-8">
                        <label for="inputContent" class="form-label">場地簡介</label> <input
                            ...
                            name="roomContent"
                            value="<%=(roomVO == null) ? "" : roomVO.getRoomContent()%>"/>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 20px">
                    <div class="col-12">
                        ...
                        <input type="hidden" name="action" value="insert"/> <input
                            type="submit" class="btn btn-outline-danger" value="新增"
