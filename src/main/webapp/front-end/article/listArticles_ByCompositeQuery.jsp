...
<%
	...
	List<ArticleVO> listArticles_ByCompositeQuery = (List<ArticleVO>) request.getAttribute("listArticles_ByCompositeQuery");
Iterator<ArticleVO> iterator = listArticles_ByCompositeQuery.iterator();
...
<body>
 ...
 <%@ include file="/front-end/article/aside.jsp" %>
  ...
  <main
	...
	<c:if test="${listArticles_ByCompositeQuery.size() == 0}"> <%-- 判斷是否有文章  --%>
	<h1 style="display: flex; justify-content:center ;">查無資料</h1>
	</c:if>
