...
<%
    ...
    List<ArticleVO> listBySearch = (List<ArticleVO>) request.getAttribute("listBySearch");
Iterator<ArticleVO> iterator = listBySearch.iterator();
...
<body>
 ...
 <%@ include file="/front-end/article/aside.jsp" %>
  ...
  <main
	...
	<c:forEach var="articleVO" items="${listBySearch}">
