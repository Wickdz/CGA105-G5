  ...
  <header class="p-3 bg-dark fixed-top" style="height: 73.33px">
    <div>
      <div class="d-flex flex-wrap justify-content-lg-start">
        <span class="fs-4 col-lg-2 me-4" style="color: white;"><a href="<%=request.getContextPath()%>/front-end/indexlogin.jsp" style="color: white;text-decoration: none;">Muscle Beach</a></span>
