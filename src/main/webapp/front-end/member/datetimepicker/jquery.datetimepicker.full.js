...
;(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['src/main/webapp/front-end/member/datetimepicker/jquery', 'jquery-mousewheel'], factory);
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define(['src/main/webapp/front-end/member/datetimepicker/jquery'], factory);
    } else if (typeof exports === 'object') {
        // Node/CommonJS style for Browserify
        module.exports = factory;
    } else {
